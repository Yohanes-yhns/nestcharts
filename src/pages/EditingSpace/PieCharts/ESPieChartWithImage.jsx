...
import styles from "./ESPieChartWithImage.module.css";

const ESPieChartWithImage = () => {
  ...
  const [data, setData] = useState([44, 33, 54, 45]);

  const [chartTitle, setChartTitle] = useState("Pie Chart With Image");
...
export default ESPieChartWithImage;
