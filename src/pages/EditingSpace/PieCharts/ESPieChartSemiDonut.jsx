...
import styles from "./ESPieChartSemiDonut.module.css";

const ESPieChartSemiDonut = () => {
  ...
  const [chartTitle, setChartTitle] = useState("Semi Donut Pie Chart");
...
export default ESPieChartSemiDonut;
