...
import styles from "./ESPieChartDonut.module.css";

const ESPieChartDonut = () => {
  ...
  const [chartTitle, setChartTitle] = useState("Donut Pie Chart");
...
export default ESPieChartDonut;
