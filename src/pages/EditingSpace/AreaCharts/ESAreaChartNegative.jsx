...
import styles from "./ESAreaChartNegative.module.css";
import Navbar from "../../../components/Navbar";
import html2canvas from "html2canvas";

const ESAreaChartNegative = () => {
  ...
  const [data, setData] = useState([0, -41, 35, -51, 0, 62, -69, 32, -32, 54]);
  const [chartTitle, setChartTitle] = useState("Negative Area Chart");
...
export default ESAreaChartNegative;
