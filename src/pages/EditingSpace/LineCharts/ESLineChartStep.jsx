...
import styles from "./ESLineChartStep.module.css";
import Navbar from "../../../components/Navbar";
import html2canvas from "html2canvas";

const ESLineChartStepLine = () => {
  ...
  const [data, setData] = useState([20, 40, 30, 100, 60, 25, 120, 50]);
  const [chartTitle, setChartTitle] = useState("Step Line Chart");
  ...
  const handleSaveChart = async () => {
    try {
      ...
      const response = await fetch("http://localhost:3000/api/charts", {
        ...
        body: JSON.stringify({
          chart_type: "line", // backend kita pakai 'line' untuk semua varian
          title: chartTitle,
          x_axis_title: xAxisTitle,
          y_axis_title: yAxisTitle,
          categories: JSON.stringify(categories),
          data: JSON.stringify([{ name: "Custom Series", data }]),
      ...
      console.error("❌ Gagal menyimpan chart:", error);
...
export default ESLineChartStepLine;
