...
import styles from "./ESLineChartDashed.module.css";

const ESLineChartDashed = () => {
  ...
  const [dataMid, setDataMid] = useState([10, 15, 20, 18, 22, 19, 21]);
  ...
  const [chartTitle, setChartTitle] = useState("Dashed Line Chart");
...
export default ESLineChartDashed;
