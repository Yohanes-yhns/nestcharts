...
import styles from "./ESRadialChartMultiple.module.css";

const ESRadialChartMultiple = () => {
  ...
  const [chartTitle, setChartTitle] = useState("Multiple Radial Chart");
...
export default ESRadialChartMultiple;
