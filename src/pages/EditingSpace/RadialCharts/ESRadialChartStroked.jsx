...
import styles from "./ESRadialChartStroked.module.css";
import Navbar from "../../../components/Navbar";
import html2canvas from "html2canvas";

const ESRadialChartStroked = () => {
  // MEMASUKAN DATA KEDALAM APEX *********************************

  const chartPreviewRef = useRef(null);

  const [categories, setCategories] = useState(["Cricket"]);
  const [data, setData] = useState([70]);
  const [chartTitle, setChartTitle] = useState("Stroked Radial Chart");
...
export default ESRadialChartStroked;
