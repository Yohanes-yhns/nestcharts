...
import styles from "./ESRadialChartCustom.module.css";

const ESRadialChartCustom = () => {
  ...
  const [data, setData] = useState([76, 67, 61, 90]);

  const [chartTitle, setChartTitle] = useState("Custom Radial Chart");
...
export default ESRadialChartCustom;
